...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown(
            "Effortlessly search and retrieve information from your documents using our advanced RAG system."
        )
        st.markdown("---")
        st.markdown(
            "[Open in GitHub](https://github.com/acn-thaihanguyen/rag_langchain)"
        )
